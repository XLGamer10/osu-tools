...
namespace PerformanceCalculatorGUI.Components
{
    public partial class DifficultyTuningPopover<TConstants> : OsuPopover
    {
        ...
        private static LimitedLabelledFractionalNumberBox createTuningBox(string label, double defaultValue)
        {
        ...
        private static LimitedLabelledNumberBox createTuningIntBox(string label, int defaultValue)
        {
